    ...
    return (
        <section className="flex border p-5 m-5 flex-grow rounded-lg gap-4">
            <div className="border basis-1/5 p-5 rounded-lg">
                ...
                <Accordion selectionMode="multiple" itemClasses={{ title: "font-semibold" }}>
                    <AccordionItem key={1} title="Gender">
                        <RadioGroup color="default" className="pb-3" value={filters.gender} onValueChange={changeGender}>
