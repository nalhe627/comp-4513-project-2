...
const ProductCard = (props) => {
    ...
    const addCart = () => {
        ...
        if (!c) {
            ...
            const newCart = [...cart, {id: props.id, name: props.name, gender: props.gender, category: props.category, description: props.description, price: props.price, cost: props.cost, color: props.color}];
